...
public readonly struct BaseValue {
    ...
    public static BaseValue FromElementsId(ElementId elementId) {
        ...
        var value = elementId.Code switch {
            ...
            ElementCode.FCUSp when lv is ElementLevel.LvB => 1.5,
            ElementCode.FCUSp when lv is ElementLevel.Lv1 => 1.7,
            ElementCode.FCUSp when lv is ElementLevel.Lv2 => 2.0,
            ElementCode.FCUSp when lv is ElementLevel.Lv3 => 2.4,
            ElementCode.FCUSp when lv is ElementLevel.Lv4 => 2.9,
            ElementCode.FCLSp when lv is ElementLevel.LvB => 1.7,
            ElementCode.FCLSp when lv is ElementLevel.Lv1 => 2.0,
            ElementCode.FCLSp when lv is ElementLevel.Lv2 => 2.4,
            ElementCode.FCLSp when lv is ElementLevel.Lv3 => 2.9,
            ElementCode.FCLSp when lv is ElementLevel.Lv4 => 3.2,
            ElementCode.FCCSp when lv is ElementLevel.LvB => 1.7,
            ElementCode.FCCSp when lv is ElementLevel.Lv1 => 2.0,
            ElementCode.FCCSp when lv is ElementLevel.Lv2 => 2.3,
            ElementCode.FCCSp when lv is ElementLevel.Lv3 => 2.8,
            ElementCode.FCCSp when lv is ElementLevel.Lv4 => 3.2,
            ElementCode.FCSSp when lv is ElementLevel.LvB => 1.6,
            ElementCode.FCSSp when lv is ElementLevel.Lv1 => 1.9,
            ElementCode.FCSSp when lv is ElementLevel.Lv2 => 2.3,
            ElementCode.FCSSp when lv is ElementLevel.Lv3 => 2.6,
            ElementCode.FCSSp when lv is ElementLevel.Lv4 => 3.0,
            ElementCode.FCoSp when lv is ElementLevel.LvB => 1.5,
            ElementCode.FCoSp when lv is ElementLevel.Lv1 => 1.7,
            ElementCode.FCoSp when lv is ElementLevel.Lv2 => 2.0,
            ElementCode.FCoSp when lv is ElementLevel.Lv3 => 2.5,
            ElementCode.FCoSp when lv is ElementLevel.Lv4 => 3.0,
            ElementCode.FCCoSp when lv is ElementLevel.LvB => 1.7,
            ElementCode.FCCoSp when lv is ElementLevel.Lv1 => 2.0,
            ElementCode.FCCoSp when lv is ElementLevel.Lv2 => 2.5,
            ElementCode.FCCoSp when lv is ElementLevel.Lv3 => 3.0,
            ElementCode.FCCoSp when lv is ElementLevel.Lv4 => 3.2,
            ...
            ElementCode.CoSp when lv is ElementLevel.Lv1 => 2.6,
            ElementCode.CoSp when lv is ElementLevel.Lv2 => 3.6,
            ElementCode.CoSp when lv is ElementLevel.Lv3 => 4.6,
            ElementCode.CoSp when lv is ElementLevel.Lv4 => 5.6,
